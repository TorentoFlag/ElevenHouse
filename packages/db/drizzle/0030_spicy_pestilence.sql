...
ALTER TABLE "flow_execution_signal_inbox" DROP CONSTRAINT "flow_execution_signal_inbox_type_check";--> statement-breakpoint
ALTER TABLE "flow_execution_signal_waits" DROP CONSTRAINT "flow_execution_signal_waits_type_check";--> statement-breakpoint
ALTER TABLE "flow_execution_signal_waits" DROP CONSTRAINT "flow_execution_signal_waits_node_check";--> statement-breakpoint
ALTER TABLE "flow_execution_signal_waits" ADD COLUMN "failure_handle" text;--> statement-breakpoint
ALTER TABLE "outbox_events" ADD CONSTRAINT "outbox_events_messaging_delivery_terminal_payload_check" CHECK ("outbox_events"."event_type" <> 'messaging.message.delivery_terminal.v1' or (
        "outbox_events"."payload"->>'messageId' = "outbox_events"."aggregate_id"::text
        and "outbox_events"."payload"->>'schemaVersion' = 'messaging-message-delivery-terminal.v1'
        and "outbox_events"."payload"->>'outcome' in ('succeeded', 'failed')
...
ALTER TABLE "flow_versions" ADD CONSTRAINT "flow_versions_capability_manifest_schema_check" CHECK ((
  ...
  AND (
    ...
    WHEN jsonb_typeof(graph->'nodes') = 'array' THEN
      ...
      AND jsonb_path_query_array(graph->'nodes', '$[*].kind') <@ '["booking_confirmed","manual_client","birth_data_available","natal_chart_request","natal_chart_ai_draft","send_message","astrologer_work_item","astrologer_approval","completed","suppressed","failed"]'::jsonb
    ELSE FALSE
  END
    AND CASE
  ...
  END
    ...
    WHEN jsonb_typeof(capability_manifest->'requiredCapabilities') = 'array' THEN
      ...
      AND capability_manifest->'requiredCapabilities' <@ '["bookings.events.booking_confirmed","clients.birth_data.read.service_preparation","products.read","charts.calculate.natal.booking_context","charts.interpret.natal.ai_draft","messaging.outbound.send.existing_thread"]'::jsonb
      AND jsonb_array_length(jsonb_path_query_array(
...
ALTER TABLE "flow_execution_attempts" ADD CONSTRAINT "flow_execution_attempts_trace_summary_schema_check" CHECK ("flow_execution_attempts"."trace_summary" ?& array[
        ...
        and "flow_execution_attempts"."trace_summary"->>'nodeKind' in ('birth_data_available', 'natal_chart_request', 'natal_chart_ai_draft', 'send_message', 'astrologer_work_item', 'astrologer_approval', 'completed', 'suppressed', 'failed')
        ...
        and (
          (
            ...
            and "flow_execution_attempts"."trace_summary"->>'targetNodeKind' in ('birth_data_available', 'natal_chart_request', 'natal_chart_ai_draft', 'send_message', 'astrologer_work_item', 'astrologer_approval', 'completed', 'suppressed', 'failed')
          ...
          (
            "flow_execution_attempts"."outcome" = 'waiting'
            and "flow_execution_attempts"."trace_summary"->>'nodeKind' in ('astrologer_approval', 'natal_chart_ai_draft')
            and "flow_execution_attempts"."trace_summary"->>'outcome' = 'waiting'
          ...
          (
            ...
            and "flow_execution_attempts"."trace_summary"->>'nodeKind' in ('completed', 'suppressed', 'failed')
...
ALTER TABLE "flow_execution_tokens" ADD CONSTRAINT "flow_execution_tokens_node_kind_check" CHECK ("flow_execution_tokens"."node_kind" in ('birth_data_available', 'natal_chart_request', 'natal_chart_ai_draft', 'send_message', 'astrologer_work_item', 'astrologer_approval', 'completed', 'suppressed', 'failed'));--> statement-breakpoint
...
ALTER TABLE "flow_execution_signal_inbox" ADD CONSTRAINT "flow_execution_signal_inbox_type_check" CHECK ("flow_execution_signal_inbox"."signal_type" in ('chart.calculation.terminal.v1', 'messaging.message.delivery.terminal.v1'));--> statement-breakpoint
ALTER TABLE "flow_execution_signal_waits" ADD CONSTRAINT "flow_execution_signal_waits_type_check" CHECK ("flow_execution_signal_waits"."signal_type" in ('chart.calculation.terminal.v1', 'messaging.message.delivery.terminal.v1'));--> statement-breakpoint
ALTER TABLE "flow_execution_signal_waits" ADD CONSTRAINT "flow_execution_signal_waits_node_check" CHECK ("flow_execution_signal_waits"."node_activation_sequence" > 0
        ...
        and (
          ("flow_execution_signal_waits"."signal_type" = 'chart.calculation.terminal.v1'
            and "flow_execution_signal_waits"."success_handle" = 'next'
            and "flow_execution_signal_waits"."failure_handle" is null)
          or
          ("flow_execution_signal_waits"."signal_type" = 'messaging.message.delivery.terminal.v1'
            and "flow_execution_signal_waits"."success_handle" = 'success'
            and "flow_execution_signal_waits"."failure_handle" = 'error')
        ));