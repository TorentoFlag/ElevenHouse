...
DROP INDEX "flow_execution_signal_inbox_owner_identity_unique";--> statement-breakpoint
DROP INDEX "flow_execution_signal_waits_match_idx";--> statement-breakpoint
ALTER TABLE "flow_execution_signal_waits" ADD COLUMN "expected_source_event_id" uuid;--> statement-breakpoint
CREATE UNIQUE INDEX "flow_execution_signal_inbox_owner_identity_unique" ON "flow_execution_signal_inbox" USING btree ("owner_user_id","signal_type","correlation_id","source_event_id");--> statement-breakpoint
CREATE INDEX "flow_execution_signal_waits_match_idx" ON "flow_execution_signal_waits" USING btree ("owner_user_id","signal_type","correlation_id","expected_source_event_id","state");--> statement-breakpoint
...
ALTER TABLE "flow_execution_tokens" ADD CONSTRAINT "flow_execution_tokens_completed_node_check" CHECK ("flow_execution_tokens"."state" <> 'completed' or "flow_execution_tokens"."node_kind" in ('completed', 'suppressed', 'failed'));--> statement-breakpoint
