...
ALTER TABLE "flow_runs" DROP CONSTRAINT "flow_runs_enrollment_shape_check";--> statement-breakpoint
ALTER TABLE "flow_runtime_events" DROP CONSTRAINT "flow_runtime_events_source_check";--> statement-breakpoint
...
ALTER TABLE "flow_run_events" ADD CONSTRAINT "flow_run_events_summary_schema_check" CHECK ((
        ...
        and "flow_run_events"."summary"->>'eventKind' in ('booking_confirmed', 'manual_client', 'product_purchased', 'first_inbound_message', 'client_lifecycle_changed')
...
ALTER TABLE "flow_runs" ADD CONSTRAINT "flow_runs_enrollment_shape_check" CHECK ((
        ...
        and "flow_runs"."enrollment_policy_key" in ('once_per_occurrence', 'once_per_client', 'each_occurrence', 'after_previous_terminal')
...
ALTER TABLE "flow_runtime_events" ADD CONSTRAINT "flow_runtime_events_source_check" CHECK ("flow_runtime_events"."source" in ('crm', 'product', 'order', 'booking', 'message', 'chart', 'astro_calendar', 'manual', 'finance', 'messaging', 'clients'));--> statement-breakpoint
ALTER TABLE "flow_runtime_events" ADD CONSTRAINT "flow_runtime_events_normalized_shape_check" CHECK ((
        ...
        "flow_runtime_events"."event_kind" in ('booking_confirmed', 'manual_client', 'product_purchased', 'first_inbound_message', 'client_lifecycle_changed')
