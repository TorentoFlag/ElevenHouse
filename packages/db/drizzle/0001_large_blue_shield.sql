...
ALTER TABLE "calculation_interpretations" ADD CONSTRAINT "calculation_interpretations_version_id_calculation_versions_id_fk" FOREIGN KEY ("version_id") REFERENCES "public"."calculation_versions"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
...
ALTER TABLE "calculation_artifacts" ADD CONSTRAINT "calculation_artifacts_version_id_calculation_versions_id_fk" FOREIGN KEY ("version_id") REFERENCES "public"."calculation_versions"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
