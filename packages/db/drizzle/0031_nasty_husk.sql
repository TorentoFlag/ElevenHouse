...
ALTER TABLE "flow_execution_attempts" ADD CONSTRAINT "flow_execution_attempts_trace_summary_schema_check" CHECK ("flow_execution_attempts"."trace_summary" ?& array[
        ...
        and (
          (
            ...
            and (
              "flow_execution_attempts"."trace_summary"->>'reasonCode' = 'FLOW_EDGE_SELECTED'
              or (
                "flow_execution_attempts"."trace_summary"->>'nodeKind' = 'send_message'
                and "flow_execution_attempts"."trace_summary"->>'reasonCode' = 'FLOW_MESSAGING_DELIVERY_COMPLETED'
                and "flow_execution_attempts"."trace_summary"->>'sourceHandle' in ('success', 'error')
              )
            )
          )
          or
          ...
          (
            "flow_execution_attempts"."outcome" = 'waiting'
            and "flow_execution_attempts"."trace_summary"->>'nodeKind' = 'send_message'
            and "flow_execution_attempts"."trace_summary"->>'outcome' = 'waiting'
            and "flow_execution_attempts"."trace_summary"->>'reasonCode' = 'FLOW_MESSAGING_DELIVERY_REQUESTED'
            and "flow_execution_attempts"."trace_summary"->>'resultCode' = 'FLOW_WAITING_EXTERNAL'
          )
          or
          (
            "flow_execution_attempts"."outcome" = 'waiting'
