...
function selectRunRows(database: FlowDatabase, conditions: readonly SQL[]) {
  ...
  return database
    .select({
      ...
      triggerNodeId: flowRuns.triggerNodeId,
      occurrenceKey: flowRuns.occurrenceKey,
      enrollmentPolicyKey: flowRuns.enrollmentPolicyKey,
      enrollmentPolicyRevision: flowRuns.enrollmentPolicyRevision,
      executionAuthorityBasis: flowRuns.executionAuthorityBasis,
      executionAuthorityRefId: flowRuns.executionAuthorityRefId,
