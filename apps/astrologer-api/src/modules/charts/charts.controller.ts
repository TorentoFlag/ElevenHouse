...
export class ChartsController {
  ...
  @Post("astrocartography/jobs")
  @RequireCsrf()
  createAstrocartographyJob(@Body() body: unknown, @Req() request: AstrologerSessionRequest) {
    return this.service.createAstrocartographyJob(body, request);
  }
