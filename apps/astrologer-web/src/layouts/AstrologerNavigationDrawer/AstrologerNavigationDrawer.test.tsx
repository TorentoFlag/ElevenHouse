...
describe("AstrologerNavigationDrawerView", () => {
  it("maps astrologer navigation copy to the shared navigation drawer", () => {
    ...
    expect(element.props.items[3].icon.props.iconName).toBe("flow");
    ...
    expect(element.props.items[4].icon.props.iconName).toBe("box");
    ...
    expect(element.props.items[6].icon.props.iconName).toBe("numerology");
    ...
    expect(element.props.items[7].icon.props.iconName).toBe("orbit");
    ...
    expect(element.props.items[8].icon.props.iconName).toBe("flow");
