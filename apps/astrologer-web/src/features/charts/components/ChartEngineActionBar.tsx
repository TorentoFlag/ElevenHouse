...
export function ChartEngineActionBar({
  ...
  const utilityActions = showUtilities ? (
    <details className={styles.actionMenu} role="group" aria-label={copy.actionBar.actionsMenuLabel}>
      <summary className={styles.actionMenuTrigger}>
        <span aria-hidden="true">•••</span>
        {copy.actionBar.actionsMenu}
      </summary>
