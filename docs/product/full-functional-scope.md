...
ElevenHouse — закрытая SaaS/CRM-платформа для астрологов. Это не маркетплейс и не публичный каталог. Клиент попадает на платформу через прямую ссылку конкретного астролога, а платформа не показывает ему других астрологов.
