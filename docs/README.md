...
Эта папка — проектная память ElevenHouse. Агенты и разработчики должны использовать её как источник правды по архитектуре, scope и продуктовым решениям.
...
- `api/api-boundaries.md` — разделение public и ops API.
