...
- `/products` with real API queries, localized template-backed draft creation,
  manual type fallback and product create/edit/status actions in progress.
