...
| Destiny matrix                      | `matrix.jsx`, `matrix-data.jsx`, `matrix-graph.jsx`, `matrix-modes.jsx`                                                                                                                                                           | future `/destiny-matrix` in `astrologer-web`                                           | `Calculations`, `Matrix`, `Clients`, `AstrologerProfile`, future `Ai`, `Media`                                                                                                                  | backend core ready; notes/report/AI/PDF missing                                                                                       | missing                                                                                                  | Matrix graph, section navigation, energy table, year selector, notes/report panels                                                                         | CRM-only `ladini_22`; see the production design spec.                                                                                                                                                                                                                           |
...
arithmetic. Notes, report editing, AI, PDF and the frontend remain missing; the
full decisions live in
